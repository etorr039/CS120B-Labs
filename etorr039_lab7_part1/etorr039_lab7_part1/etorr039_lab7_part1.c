...
const unsigned long tasksPeriodGCD = 1000; // gcd of all tasks
const unsigned long periodThreeLed = 1000; // Task 1 period
const unsigned long periodBlinkingLed = 1000; // task 2 period
const unsigned long periodCombineLed = 1000; // Task 3 period
